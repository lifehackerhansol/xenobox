...
int makesplash(const int argc, const char** argv)
{
    ...
    if (argc < 2)
    {
        fprintf(stderr, "MakeSplash in C\n"
    ...
    if (argc > 2)
    {
        ...
        {
            case '1':
                type = SPLASH_MOONSHELL1;
                break;
            case '2':
                type = SPLASH_MOONSHELL2;
                break;
            case 's':
                type = SPLASH_ISAKUREAL;
                break;
            case 'm':
                type = SPLASH_M3SAKURA;
                break;
        }
    }
    ...
    {
        case 1:
            fprintf(stderr, "version error. please use 1 or 2.\n");
            break;
        case 2:
            fprintf(stderr, "configuration error\n");
            break;
        case 3:
            fprintf(stderr, "m3sakura can have up to 126 frames\n");
            break;
        case 10:
            fprintf(stderr, "file search error\n");
            break;
        case 20:
