...
// 0.79: this decoder is based on DeSmuME, but not copy any longer as I replaced functions with secure area
// encryption's.
...
#define FILLBUF     \
    if (!(xIn & 7)) \
        memcpy(curBlock, in + xIn, 8), operation(curBlock);
...
static int load(u8* data)
{
    ...
    part2ram =
        (((header.shift_amounts & 0x1000) ? 0x02800000 : 0x03810000) - (header.part2_ram_boot7_addr << (2 + shift4)));
    ...
    {
        PRINTF("Firmware: ERROR: the boot code CRC16 (0x%04X) doesn't match the value in the firmware header (0x%04X)",
               crc16_mine, header.part12_boot_crc16);
        free(tmp_data7);
        free(tmp_data9);
        free(data);
        return 4;
    ...
    if (patched)
    {
        ...
        part1ram = (0x02800000 - (header.part1_ram_boot9_addr << (2 + shift2)));
        part2addr = (header.part2_rom_boot7_addr << (2 + shift3));
        part2ram = (((header.shift_amounts & 0x1000) ? 0x02800000 : 0x03810000) -
                    (header.part2_ram_boot7_addr << (2 + shift4)));
    ...
    unsigned char ndshead[512] = {
        ,
